...
/* Экран варианта Б. Источник: design-handoff-v2/new_design_solo.jsx
      ...
      <div className="wrap page">
        ...
        <div className="shead">
          <div className="shead__ava">
            <img src={IMG["me.jpg"]} alt="Антон Ковалёв" />
            ...
            <div>
              ...
              <div className="sect">
                ...
                <div className="scrubrow">
                  <SCREENS.ScrubRail items={TIMELINE} currentIndex={TIMELINE.length - 1} />
...
Object.assign(SCREENS, { SoloProfile });
