...
/* Экран варианта Б. Источник: design-handoff-v2/new_design_land3.jsx
        ...
        <section className="wrap l3sec">
          <div className="l3ban">
            ...
            <div className="l3ban__ph">
              <image-slot id="land3-hero" shape="rect" src={IMG["pro-at-work.png"]} placeholder="Фото проектировщика"></image-slot>
