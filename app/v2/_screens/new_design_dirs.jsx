...
/* Экран варианта Б. Источник: design-handoff-v2/new_design_dirs.jsx
...
function QuickPick({ pros, secMatch, onApply, onClose }) {
  const TREE = (SCREENS.REQ_FORM && SCREENS.REQ_FORM.STAGE_TREE) || [];
  ...
  return (
    <div className="scroll">
      <div className="wrap" style={{ paddingBlock: "clamp(28px,3.5vw,48px) 60px" }}>
        ...
        <div className="ai-wrap"><SCREENS.AiPick /></div>
...
Object.assign(SCREENS, { Pick, Cat });
