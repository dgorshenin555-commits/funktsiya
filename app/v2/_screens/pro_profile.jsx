...
/* Экран варианта Б. Источник: design-handoff-v2/pro_profile.jsx
        ...
        <div className="wrap">
          ...
          <div className="pp__grid">
            <div className="pp__main">
              ...
              <SCREENS.NotifyBlock events={NOTIFY} note="Новые заявки по вашим разделам, изменения в нормативах и обновления платформы." />
...
Object.assign(SCREENS, { ProProfile, ProProfileFull: ProProfile });
