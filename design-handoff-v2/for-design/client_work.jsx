/* client_work.jsx — рабочая область заказчика, минималистичная версия.
   Порядок экрана: кто я (визитка с рейтингом и отзывами) → что в работе →
   что отработано. Ничего лишнего в потоке: детали раскрываются по клику. */
(() => {
  ...
  Object.assign(window, { ClientWork });
})();
