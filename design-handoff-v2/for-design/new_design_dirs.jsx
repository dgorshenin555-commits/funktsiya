/* new_design_dirs.jsx — экран варианта Б, выгружен из основного проекта.
...
(function () {
  ...
  /* ---------------- производители ---------------- */
  const MAKERS = [
    { name: "Ridan", logo: "assets/ridan.webp", img: "assets/ridan-hex.jpg", cat: "Теплоснабжение · ИТП", city: "Московская обл.", note: "Пластинчатые теплообменники, балансировочные клапаны, насосные группы для ИТП.", bim: true, items: 1840, secs: ["ОВ", "ТС"], lead: "от 5 дней", sup: "Подбор по ТЗ" },
    { name: "Knauf", logo: null, img: "assets/knauf-aquapanel.jpg", cat: "Ограждающие конструкции", city: "Красногорск", note: "Aquapanel и системы сухого строительства: типовые узлы, расчёт огнестойкости.", bim: true, items: 620, secs: ["АР", "КЖ"], lead: "склад", sup: "Узлы в DWG" },
    { name: "Caparol", logo: "assets/caparol-logo.webp", img: null, cat: "Фасады и отделка", city: "Москва", note: "Фасадные системы СФТК, колеровка, ведомости отделки под раздел АР.", bim: false, items: 410, secs: ["АР"], lead: "от 3 дней", sup: "Колер-подбор" },
    { name: "Vandjord", logo: "assets/vandjord.jpg", img: "assets/vandjord-station.jpg", cat: "Водоотведение · ливнёвка", city: "Санкт-Петербург", note: "Очистные сооружения поверхностного стока, КНС, дренажные системы.", bim: true, items: 275, secs: ["ВК", "НВК"], lead: "от 14 дней", sup: "Гидравлический расчёт" },
    { name: "Немен", logo: "assets/nemen.png", img: null, cat: "Металлоконструкции", city: "Тула", note: "Балки, фермы, профнастил. Ведомости КМ и расчёт узлов под нагрузку.", bim: true, items: 130, secs: ["КМ"], lead: "от 20 дней", sup: "Расчёт узлов" },
  ];
