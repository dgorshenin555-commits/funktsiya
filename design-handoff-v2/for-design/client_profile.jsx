/* client_profile.jsx — профиль заказчика, универсальная форма.
   Заказчик бывает двух видов, и это меняет не оформление, а содержание:
   у организации проверяют ЕГРЮЛ и подписанта, у частного лица этого нет
   вовсе — зато нужны подтверждение личности и права на объект. Поэтому
   все различия собраны в CFG, а разметка одна. */
(() => {
          ...
          <div className="wrap">
            ...
            <div className="pp__grid">
              <div className="pp__main">
                ...
                <window.NotifyBlock events={NOTIFY} note="Новые исполнители по вашим разделам, изменения в нормативах и обновления платформы." />
  ...
  Object.assign(window, { ClientProfile });
})();
