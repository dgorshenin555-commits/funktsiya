/* auth_panel.jsx — панель «Войти на платформу» в шапке главной.
   Приёмы взяты из премиального auth-компонента (табы вход/регистрация,
   валидация на месте, состояние загрузки и успеха), но на наших стилях
   и на нашей схеме входа — телефон и код, без пароля. */
(function () {
