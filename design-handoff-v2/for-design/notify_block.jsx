/* notify_block.jsx — блок уведомлений, общий для профилей заказчика и
   исполнителя. Каналы одни (СМС, письмо, рассылка), события разные —
   приходят в props. */
(() => {
  ...
  Object.assign(window, { NotifyBlock });
})();
