/* new_design_wizard.jsx — «Создание заявки»: полный мастер из 5 шагов
   Перенос один-в-один из старого экрана OrderNew (screens_orders.jsx):
   типы объектов, назначения, разделы ПП РФ №87, помощник, ориентир рынка,
   календарь, файлы и живой предпросмотр — в языке paper / ink / acid. */
(function () {
