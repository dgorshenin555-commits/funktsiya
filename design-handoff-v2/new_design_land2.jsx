/* new_design_land2.jsx — лендинг для исполнителей, вариант 2:
   крупный герой, кнопки-пилюли, фото с плавающими метками ролей и карточкой,
   большое утверждение, живая выдача заявок, тарифы, приложение. */
(function () {
          ...
          <section className="wrap l2hero">
            ...
            <div className="l2ph">
              ...
              <div className="l2ph__img">
                <image-slot id="land2-hero" shape="rounded" radius="26" src="assets/pro-at-work.png" placeholder="Фото проектировщика за работой"></image-slot>
              </div>
