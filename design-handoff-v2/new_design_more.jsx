/* new_design_more.jsx — Нормативы, Сообщения, Доверие, Тарифы, Настройки */
(function () {
  ...
  function Messages() {
    ...
    return (
      <div className="scroll">
        ...
        {call && <window.Call who={THREADS[i].who} onEnd={() => setCall(false)} />}
      </div>
    );
  }
  ...
  Object.assign(window, { Standards, Messages, Trust, Pricing, Settings });
})();
